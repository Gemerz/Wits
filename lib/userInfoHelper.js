...
function getWitsconfigData() {
    try {
        if (!_.isEmpty(module.exports.WITS_USER_DATA)) {
            return module.exports.WITS_USER_DATA;
        }
        ...
        // if (_.isEqual(witsconfigInfo, {})) {
        //     console.warn(
        //         'Please check .witsconfig.json is empty. If so, "wits -i" is required.'
        //     );
        // }

        module.exports.WITS_USER_DATA = witsconfigInfo;
        return witsconfigInfo;
    } catch (e) {
        console.error(`Failed to getWitsconfig: ${e}`);
        util.exit();
    }
}
